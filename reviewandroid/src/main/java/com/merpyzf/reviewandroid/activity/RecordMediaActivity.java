 ...
 *
 */
public class RecordMediaActivity extends Activity implements OnClickListener
{
...
//    }
    ...
    class ShowRecorderAdpter extends BaseAdapter {
        ...
        public View getView(final int postion, View arg1, ViewGroup arg2) {
            View views = LayoutInflater.from(RecordMediaActivity.this).inflate(
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.start:
                ...
                break;
            case R.id.stop:
                if (saveFilePath.exists() && saveFilePath != null && myRecorder != null) {
                    myRecorder.stop();
                    myRecorder.release();
                    // 判断是否保存 如果不保存则删除
